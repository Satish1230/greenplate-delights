...
import { ArrowRight, Briefcase, Clock, Users, ClipboardCheck, Building, CheckCircle, XCircle } from 'lucide-react';
    ...
    <div className="min-h-screen bg-sage-50 relative">
      ...
      <main className="pt-20 pb-16 md:pt-28 md:pb-20">
        ...
        <section className="py-16 md:py-24 relative overflow-hidden">
          ...
          <div className="absolute inset-0 bg-gradient-to-b from-sage-50 to-sage-100/50 -z-10"></div>
          ...
          <div ref={comparisonRef} className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="text-center max-w-3xl mx-auto mb-12">
              ...
              <h2 className={`text-3xl md:text-4xl font-serif font-medium text-sage-800 mb-6 transition-all duration-700 delay-100 ease-out ${comparisonIsInView ? 'opacity-100' : 'opacity-0'}`}>
                Green Plate vs. Conventional Corporate Meals
              </h2>
              ...
              <p className={`text-lg text-sage-600 transition-all duration-700 delay-200 ease-out ${comparisonIsInView ? 'opacity-100' : 'opacity-0'}`}>
                Not all meal services are created equal. See how our approach to corporate nutrition stands apart.
              </p>
            </div>
            ...
            <div className={`grid md:grid-cols-2 gap-8 md:gap-12 transition-all duration-1000 delay-300 ease-out ${comparisonIsInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}>
              <div className="bg-white rounded-2xl shadow-sm p-6 md:p-8 border border-sage-200">
                ...
                <h3 className="text-xl md:text-2xl font-serif font-medium text-sage-800 mb-6">
                  The Green Plate Approach
                </h3>
                <ul className="space-y-4">
                  {[
                    "Homely, freshly prepared meals that taste like they're made in your kitchen",
                    "No preservatives, no palm oil, and no artificial additives – just pure ingredients",
                    "Customized to your team's dietary needs and preferences",
                    "Eco-friendly packaging aligning with your company's sustainability goals",
                    "Responsive service with a dedicated account manager for your organization",
                    "Menu rotation based on seasonal ingredients for optimal nutrition"
                  ].map((point, index) => (
              ...
              <div className="bg-white/80 rounded-2xl shadow-sm p-6 md:p-8 border border-sage-200">
                ...
                <h3 className="text-xl md:text-2xl font-serif font-medium text-sage-800 mb-6">
                  Conventional Meal Services
                </h3>
                <ul className="space-y-4">
                  {[
                    "Mass-produced meals lacking the personal touch and authentic flavors",
                    "Filled with preservatives and additives to extend shelf life",
                    "One-size-fits-all approach without consideration for individual needs",
                    "Excessive plastic packaging contributing to environmental waste",
                    "Impersonal service with little flexibility for changes",
                    "Limited menu options repeated frequently regardless of seasonality"
                  ].map((point, index) => (
                    <li key={index} className="flex items-start gap-3">
                ...
                <div className="mt-8">
                  <p className="text-center text-sage-600 italic">
                    Don't settle for less when it comes to nourishing your team.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className={`mt-12 md:mt-16 max-w-3xl mx-auto text-center p-6 md:p-10 bg-sage-100/70 rounded-xl border border-sage-200 shadow-sm transition-all duration-1000 delay-400 ease-out ${comparisonIsInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}>
              <h3 className="text-xl md:text-2xl font-serif font-medium text-sage-800 mb-3">
                Make the Switch That Your Team Will Thank You For
              </h3>
              <p className="text-sage-600 mb-6">
                More than 92% of employees report higher job satisfaction when their workplace provides quality, nutritious meals. Invest in your team's wellbeing and see the difference in productivity and morale.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button onClick={handleSubscribeClick} className="premium-button flex items-center gap-2 group">
                  Start Your Corporate Plan
                  <ArrowRight size={18} className="transition-transform group-hover:translate-x-1" />
                </Button>
                <Button onClick={handleWhatsAppClick} variant="outline" className="bg-white text-sage-700 border-sage-200 hover:bg-sage-50 flex items-center gap-2">
                  <svg 
